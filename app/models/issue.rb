...
class Issue < ActiveRecord::Base
  ...
  def copy_from(arg)
    ...
    self.assigned_to_ids = issue.assigned_to_ids
...
#                       :joins => User.table_name)
  ...
  def create_journal
    if @current_journal
      # attributes changes
      (Issue.column_names - %w(id description root_id lft rgt lock_version created_on updated_on) + ['assigned_to_ids']).each {|c|
